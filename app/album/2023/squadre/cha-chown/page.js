...
export default function Home() {
  const images = [
    "/album/2023/fotosquadre/cha-chown.jpg",
    "/album/2023/squadre/cha-chown/berto.jpg",
    "/album/2023/squadre/cha-chown/biglie.jpg",
    "/album/2023/squadre/cha-chown/fla.jpg",
    "/album/2023/squadre/cha-chown/gero.jpg",
    "/album/2023/squadre/cha-chown/ievo.jpg",
    "/album/2023/squadre/cha-chown/misso.jpg",
    "/album/2023/squadre/cha-chown/yuri.jpg",
    "/album/2023/squadre/cha-chown/capi.jpg",
  ];
        ...
        <nav className="mt-8">
          <div className="flex justify-center grid grid-cols-6 max-w-8xl">
            <div className="text-center mr-4 border rounded-full px-8 py-4 mb-6 text-white border-[#a6a6a7]">
              <Link href="squadre/acarimolesti">
            ...
            <div className="text-center mr-4 border rounded-full px-8 py-4 mb-6 text-white border-[#a6a6a7]">
              <Link href="squadre/fcvascoprealpi">
                <h3 className="roboto-thin text-xl">FC Vasco Prealpi</h3>
              </Link>
            </div>
            <div className="text-center mr-4 border rounded-full px-8 py-4 mb-6 text-white border-[#a6a6a7]">
              <Link href="squadre/fcvesuvio">
